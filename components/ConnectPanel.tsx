...
export default function ConnectPanel() {
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/moaz-haider/',
      icon: (
    ...
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/moaz.haider.14',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/moazhaider5/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {contactInfo.map((info) => (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="font-medium group-hover:underline" style={{ color: 'var(--text)' }}>
                {info.value}
              </div>
            </div>
          </a>
