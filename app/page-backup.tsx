  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        {/* Hero Section */}
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50/30 dark:bg-slate-900">
          ...
          <div className="container mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="animate-fade-in">
                <div className="inline-block px-4 py-2 bg-primary/20 border border-primary/20 rounded-full text-sm font-bold text-primary mb-6">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
                  ...
                  <br />
                  <span className="text-slate-900 dark:text-white">Consultant</span>
                </h1>
              ...
              <div className="animate-fade-in">
                <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 relative overflow-hidden shadow-2xl border border-slate-200 dark:border-slate-700">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-slate-800 dark:text-slate-400 mb-6 leading-relaxed text-center text-sm">
                    ...
                    <form className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        <input
                          ...
                          className="px-4 py-3 rounded-xl bg-gradient-to-br from-blue-50/30 to-slate-50 dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary text-sm placeholder:text-slate-400"
                          required
                        />
                        <input
                          type="email"
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-gradient-to-br from-blue-50/30 to-slate-50 dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary text-sm placeholder:text-slate-400"
                        required
                      />
                      <textarea
                        placeholder="Tell me about your goals (optional)"
                        rows={3}
                        className="w-full px-4 py-3 rounded-xl bg-gradient-to-br from-blue-50/30 to-slate-50 dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary text-sm resize-none placeholder:text-slate-400"
                      />
                      <button
                        type="submit"
                    ...
                    <div className="flex flex-col items-center gap-3 text-xs text-slate-800 dark:text-slate-400 mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
        ...
        {/* Trust Strip */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 border-y border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 to-blue-50/30 dark:bg-slate-900">
          <div className="container mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <div className="text-sm text-slate-800 dark:text-slate-400 font-semibold">Keywords Mapped</div>
              </div>
              <div>
                <div className="text-5xl font-black bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent mb-2">6</div>
                <div className="text-sm text-slate-800 dark:text-slate-400 font-semibold">International Markets</div>
              </div>
              <div>
                <div className="text-5xl font-black bg-gradient-to-r from-accent to-primary bg-clip-text text-transparent mb-2">187%</div>
                <div className="text-sm text-slate-800 dark:text-slate-400 font-semibold">Avg Traffic Growth</div>
              </div>
              <div>
                <div className="text-5xl font-black bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent mb-2">100%</div>
                <div className="text-sm text-slate-800 dark:text-slate-400 font-semibold">Ecommerce Focused</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 px-4 sm:px-6 lg:px-8 reveal bg-white dark:bg-slate-950">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-900 dark:text-slate-200 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {caseStudies.map((study, index) => (
                <div
                  key={index}
                  className="premium-card rounded-2xl p-8 relative overflow-hidden group border-2 border-slate-200 dark:border-slate-700 hover:border-primary transition-all"
                >
                  {/* Gradient accent */}
                  ...
                  <div className="relative">
                    ...
                    <div className="flex items-center gap-2 mb-4 flex-wrap">
                      <span className="px-3 py-1.5 bg-primary/20 text-primary rounded-full text-sm font-medium border border-primary/20">
                        {study.platform}
                      </span>
                      <span className="px-3 py-1.5 bg-secondary/20 text-secondary rounded-full text-sm font-medium border border-secondary/20">
                        {study.country}
                      </span>
                    </div>
        ...
        {/* About Moaz */}
        <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-blue-50/30 dark:bg-slate-900 reveal relative overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative">
                ...
                <div className="flex items-center gap-4 mt-8">
                  ...
                  <div className="flex items-center gap-3 text-slate-800 dark:text-slate-400 text-sm">
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        <svg className="w-5 h-5 text-slate-600 dark:text-slate-400 group-hover:text-blue-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      >
                        ...
                        <svg className="w-5 h-5 text-slate-600 dark:text-slate-400 group-hover:text-gray-700 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                      </a>
                      ...
                      >
                        ...
                        <svg className="w-5 h-5 text-slate-600 dark:text-slate-400 group-hover:text-blue-600 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                      </a>
                      ...
                      >
                        ...
                        <svg className="w-5 h-5 text-slate-600 dark:text-slate-400 group-hover:text-pink-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                      </a>
                    </div>
        ...
        {/* Services */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 reveal bg-gradient-to-br from-blue-50/30 to-slate-50 dark:bg-slate-900">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-4">
                Ecommerce SEO Services
              </h2>
              <p className="text-lg text-slate-900 dark:text-slate-200 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {services.map((service, index) => (
                <Link
                  key={index}
                  href={service.href}
                  className="premium-card rounded-2xl p-8 group relative overflow-hidden border-2 border-slate-200 dark:border-slate-700 hover:border-primary transition-all"
                >
                  {/* Icon background */}
                  ...
                  <p className="text-slate-900 dark:text-slate-200 leading-relaxed text-sm">
                    {service.description}
                  </p>
        ...
        {/* Platforms */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-blue-50/30 dark:bg-slate-900 reveal">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {platforms.map((platform, index) => (
                <Link
                  key={index}
                  href={platform.href}
                  className="premium-card rounded-2xl p-6 group relative overflow-hidden border-2 border-slate-200 dark:border-slate-700 hover:border-primary transition-all"
                >
                  {/* Platform icon */}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {industries.map((industry, index) => (
                <Link
                  key={index}
                  href={industry.href}
                  className="premium-card rounded-2xl p-6 group relative overflow-hidden border-2 border-slate-200 dark:border-slate-700 hover:border-accent transition-all"
                >
                  {/* Decorative gradient */}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {countries.map((country, index) => (
                <Link
                  key={index}
                  href={country.href}
                  className="premium-card rounded-2xl p-8 text-center group relative overflow-hidden border-2 border-slate-200 dark:border-slate-700 hover:border-primary transition-all"
                >
        ...
        {/* Contact Strip */}
        <section className="py-12 px-4 sm:px-6 lg:px-8 border-y border-slate-200 dark:border-slate-700 bg-gradient-to-br from-slate-50 to-blue-50/30 dark:bg-slate-900">
          <div className="container mx-auto">
            <div className="flex flex-col md:flex-row justify-center items-center gap-8 text-center md:text-left">
              <div>
                <div className="text-sm text-slate-900 dark:text-slate-200 mb-1">Email</div>
                <a
                  href="mailto:contact@moazhaider.com"
              ...
              <div>
                <div className="text-sm text-slate-900 dark:text-slate-200 mb-1">Phone</div>
                <a
